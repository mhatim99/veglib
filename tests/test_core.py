"""
Tests for VegLib core functionality.
"""
...
from veglib import VegLib, quick_diversity_analysis, quick_elbow_analysis


class TestVegLibCore:
    """Test core VegLib functionality."""
    ...
    def test_veglib_initialization(self):
        """Test VegLib initialization."""
        veg = VegLib()
