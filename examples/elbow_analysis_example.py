"""
Comprehensive Elbow Analysis Example for VegLib
...
from veglib import VegLib, quick_elbow_analysis, VegetationClustering

def demonstrate_elbow_analysis():
    """Demonstrate comprehensive elbow analysis functionality."""
    
    print("=== VegLib Comprehensive Elbow Analysis Demonstration ===\n")
    ...
    print("\n" + "="*60)
    print("METHOD 1: Using VegLib Main Class")
    print("="*60)
