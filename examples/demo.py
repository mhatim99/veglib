...
This script demonstrates the main functionality of VegLib including
the comprehensive elbow analysis for optimal cluster determination.

Run with: veglib-demo
"""
...
def main():
    """Main demo function."""
    print("=" * 60)
    print("VegLib Demonstration Script")
    print("Comprehensive Vegetation Data Analysis")
    print("=" * 60)
    
    try:
        from veglib import VegLib, quick_elbow_analysis
        print("✓ VegLib imported successfully")
    except ImportError as e:
        print(f"✗ Could not import VegLib: {e}")
        return
    ...
    # Initialize VegLib
    print("\n2. Initializing VegLib...")
    veg = VegLib()
    veg.species_matrix = vegetation_data
    print("✓ VegLib initialized with synthetic data")
    ...
    print("\n" + "=" * 60)
    print("✅ VegLib demonstration completed successfully!")
    print("📚 For more examples, see: https://veglib.readthedocs.io/")
    print("🐛 Report issues: https://github.com/mzhatim/veglib/issues")
    print("=" * 60)
