...
class InteractiveVisualizer:
    ...
    def save_dashboard(self, dashboard: Dict[str, Any], 
        ...
        if format == 'html':
            ...
            html_parts = []
            html_parts.append('<html><head><title>VegLib Dashboard</title></head><body>')
            html_parts.append('<h1>VegLib Analysis Dashboard</h1>')
...
class ReportGenerator:
    ...
    def generate_analysis_report(self, 
        ...
        ----------
        results : Dict[str, Any]
            Analysis results from various VegLib methods
...
<html>
<head>
    <title>VegLib Analysis Report</title>
    <style>
...
<body>
    <h1>VegLib Vegetation Analysis Report</h1>
    ...
    <hr>
    <p><em>Report generated by VegLib - A comprehensive Python package for vegetation data analysis</em></p>
</body>
</html>
            """
            ...
            return """
# VegLib Vegetation Analysis Report
...
---
*Report generated by VegLib - A comprehensive Python package for vegetation data analysis*
            """
    ...
    def _generate_simple_report(self, results: Dict[str, Any], 
        ...
        report_lines = []
        report_lines.append("VegLib Vegetation Analysis Report")
...
def quick_analysis_report(results: Dict[str, Any], 
    ...
    ----------
    results : Dict[str, Any]
        Analysis results from VegLib methods
    data_summary : Dict[str, Any], optional
        Data summary statistics
    filename : str, optional
        Output filename, by default 'veglib_report'
    format : str, optional
        Output format, by default 'html'
