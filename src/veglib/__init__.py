"""
VegLib: A comprehensive Python package for vegetation data analysis and environmental modeling.
...
from .core import VegLib, quick_diversity_analysis, quick_ordination, quick_clustering, quick_elbow_analysis
...
LONG_DESCRIPTION = """
VegLib is a professional-grade Python package designed specifically for vegetation data analysis 
...
==========================
- Documentation: https://veglib.readthedocs.io/
- GitHub: https://github.com/mzhatim/veglib
- Issues: https://github.com/mzhatim/veglib/issues
...
def show_versions():
    """Display version information for VegLib and dependencies."""
    print(f"VegLib version: {__version__}")
...
def citation():
    """Return citation information for VegLib."""
    return f"""
To cite VegLib in publications, please use:
...
# Configure warnings for VegLib
def configure_warnings():
    """Configure warning filters for VegLib."""
    warnings.filterwarnings('default', category=UserWarning, module='veglib')
